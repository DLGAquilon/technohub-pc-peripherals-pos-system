...
namespace FinalCPE142LProject.Repositories
{
    ...
    {
        private string connectionString = @"Data Source=DESKTOP-M1OG82B\SQLEXPRESS01;Initial Catalog=dboProject;Integrated Security=True;Trust Server Certificate=True";
